...
## To Run this project, just clone it and run npm install in the root after install run npm start. Then go to server folder and run npm install after install run npm start.
